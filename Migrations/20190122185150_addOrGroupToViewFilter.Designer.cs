...
namespace GidIndustrial.Gideon.WebApi.Migrations
{
    ...
    [Migration("20190122185150_addOrGroupToViewFilter")]
    partial class addOrGroupToViewFilter
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GidIndustrial.Gideon.WebApi.Models.ScannerActionRelatePieceParts", b =>
                {
                    ...
                    b.Property<int?>("ChildPartScannerLabelTypeId");
                    ...
                    b.Property<int?>("ParentPartScannerLabelTypeId");

                    b.Property<int?>("ScannerEventId");

                    b.HasKey("Id");

                    b.HasIndex("ChildPartScannerLabelTypeId");

                    b.HasIndex("ParentPartScannerLabelTypeId");

                    b.HasIndex("ScannerEventId")
                        .IsUnique()
                        .HasFilter("[ScannerEventId] IS NOT NULL");
            ...
            modelBuilder.Entity("GidIndustrial.Gideon.WebApi.Models.ScannerActionUpdateWorkLog", b =>
                {
                    ...
                    b.Property<int?>("UserScannerLabelTypeId");
                    ...
                    b.HasIndex("UserScannerLabelTypeId");

                    b.ToTable("ScannerActionUpdateWorkLog");
                });

            modelBuilder.Entity("GidIndustrial.Gideon.WebApi.Models.ScannerEvent", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("ScannerEventLabelTypeId")
                        .IsRequired();
                    ...
                    b.HasAlternateKey("ScannerEventLabelTypeId");

                    b.ToTable("ScannerEvent");
                });

            modelBuilder.Entity("GidIndustrial.Gideon.WebApi.Models.ScannerEventScannerLabelType", b =>
                {
                    b.Property<int?>("ScannerEventId");

                    b.Property<int?>("ScannerLabelTypeId");

                    b.HasKey("ScannerEventId", "ScannerLabelTypeId");

                    b.HasIndex("ScannerLabelTypeId");

                    b.ToTable("ScannerEventScannerLabelType");
                });
            ...
            modelBuilder.Entity("GidIndustrial.Gideon.WebApi.Models.ScannerStation", b =>
                {
                    ...
                    b.Property<int?>("DefaultScannerLabelTypeId");
                    ...
                    b.HasIndex("DefaultScannerLabelTypeId");
            ...
            modelBuilder.Entity("GidIndustrial.Gideon.WebApi.Models.ScannerActionRelatePieceParts", b =>
                {
                    b.HasOne("GidIndustrial.Gideon.WebApi.Models.ScannerLabelType", "ChildPartScannerLabelType")
                        .WithMany()
                        .HasForeignKey("ChildPartScannerLabelTypeId");

                    b.HasOne("GidIndustrial.Gideon.WebApi.Models.ScannerLabelType", "ParentPartScannerLabelType")
                        .WithMany()
                        .HasForeignKey("ParentPartScannerLabelTypeId");

                    b.HasOne("GidIndustrial.Gideon.WebApi.Models.ScannerEvent")
                        .WithOne("ScannerActionRelatePieceParts")
                        .HasForeignKey("GidIndustrial.Gideon.WebApi.Models.ScannerActionRelatePieceParts", "ScannerEventId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("GidIndustrial.Gideon.WebApi.Models.ScannerActionUpdateLocation", b =>
                {
                    ...
                    b.HasOne("GidIndustrial.Gideon.WebApi.Models.ScannerEvent")
                        ...
                        .HasForeignKey("GidIndustrial.Gideon.WebApi.Models.ScannerActionUpdateLocation", "ScannerEventId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("GidIndustrial.Gideon.WebApi.Models.ScannerActionUpdateSystemData", b =>
                {
                    b.HasOne("GidIndustrial.Gideon.WebApi.Models.ScannerEvent")
                        ...
                        .HasForeignKey("GidIndustrial.Gideon.WebApi.Models.ScannerActionUpdateSystemData", "ScannerEventId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("GidIndustrial.Gideon.WebApi.Models.ScannerActionUpdateWorkLog", b =>
                {
                    ...
                    b.HasOne("GidIndustrial.Gideon.WebApi.Models.ScannerEvent")
                        ...
                        .HasForeignKey("GidIndustrial.Gideon.WebApi.Models.ScannerActionUpdateWorkLog", "ScannerEventId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("GidIndustrial.Gideon.WebApi.Models.ScannerLabelType", "UserScannerLabelType")
                        .WithMany()
                        .HasForeignKey("UserScannerLabelTypeId");
                });

            modelBuilder.Entity("GidIndustrial.Gideon.WebApi.Models.ScannerEvent", b =>
                {
                    b.HasOne("GidIndustrial.Gideon.WebApi.Models.ScannerLabelType", "EventLabelType")
                        .WithMany()
                        .HasForeignKey("ScannerEventLabelTypeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("GidIndustrial.Gideon.WebApi.Models.ScannerEventScannerLabelType", b =>
                {
                    b.HasOne("GidIndustrial.Gideon.WebApi.Models.ScannerEvent", "ScannerEvent")
                        .WithMany("DataLabelTypes")
                        .HasForeignKey("ScannerEventId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("GidIndustrial.Gideon.WebApi.Models.ScannerStation", b =>
                {
                    b.HasOne("GidIndustrial.Gideon.WebApi.Models.ScannerLabelType", "DefaultScannerLabelType")
                        .WithMany()
                        .HasForeignKey("DefaultScannerLabelTypeId");
